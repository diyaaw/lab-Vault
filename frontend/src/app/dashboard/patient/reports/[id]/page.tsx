                ...
                <div className="lg:col-span-12 xl:col-span-4 space-y-6">
                    ...
                    <div className="bg-[#4F6F6F] p-8 rounded-[40px] shadow-lg text-white">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h3 className="text-lg font-black tracking-tight line-clamp-1">AI Health Summary</h3>
                        </div>
                        <div className="bg-white/10 p-6 rounded-3xl border border-white/20 backdrop-blur-sm">
                            <p className="text-sm italic font-medium leading-relaxed whitespace-pre-line">
                                {report.aiSummary || 'Automated analysis is being generated to help you understand your results. Please consult your physician for a full assessment.'}
                            </p>
                        </div>
                    </div>
